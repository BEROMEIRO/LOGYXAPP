...
import 'token_solicitado_user_name_model.dart';
export 'token_solicitado_user_name_model.dart';

class TokenSolicitadoUserNameWidget extends StatefulWidget {
  const TokenSolicitadoUserNameWidget({super.key});

  @override
  State<TokenSolicitadoUserNameWidget> createState() =>
      _TokenSolicitadoUserNameWidgetState();
}

class _TokenSolicitadoUserNameWidgetState
    extends State<TokenSolicitadoUserNameWidget> with TickerProviderStateMixin {
  late TokenSolicitadoUserNameModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TokenSolicitadoUserNameModel());
                                                                        ...
                                                                        Padding(
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            onPressed:
                                                                              ...
                                                                              _model.aPIRecebeTelefoneEmail = await APIRetornaTelefoneEmailCall.call(
                                                                              ...
                                                                              if ((_model.aPIRecebeTelefoneEmail?.succeeded ?? true)) {
                                                                                ...
                                                                                await showDialog(
                                                                                  ...
                                                                                  builder: (alertDialogContext) {
                                                                                    return AlertDialog(
                                                                                      content: const Text('Usuário não encontrado tente novamente!'),
                                                                                      actions: [
                                                                                        TextButton(
                                                                              ...
                                                                              context.goNamed(
                                                                                'Token-solicitadoWppEmailSms',
                                                                                queryParameters: {
                                                                                  'userName': serializeParam(
                                                                                    _model.nomeTxtFieldTextController.text,
                                                                                    ParamType.String,
                                                                                  ),
                                                                                }.withoutNulls,
                                                                              );
