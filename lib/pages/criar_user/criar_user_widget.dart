...
import 'criar_user_model.dart';
export 'criar_user_model.dart';

class CriarUserWidget extends StatefulWidget {
  const CriarUserWidget({super.key});

  @override
  State<CriarUserWidget> createState() => _CriarUserWidgetState();
}

class _CriarUserWidgetState extends State<CriarUserWidget>
    with TickerProviderStateMixin {
  late CriarUserModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CriarUserModel());
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      safeSetState(() {
        ...
        _model.cPFTxtFieldTextController?.clear();
        _model.unidadeTxtFieldTextController?.clear();
        _model.senhaTxtFieldTextController?.clear();
        _model.senhaConfTxtFieldTextController?.clear();
      });
    });
                                                                    ...
                                                                    builder:
                                                                      ...
                                                                      return AlertDialog(
                                                                        title: const Text(
                                                                            'Atenção!!'),
                                                                        content:
                                                                            const Text('Verifique se estas informações estão corretas: Usuário: \"O nome de usuário deve conter pelo menos 6 caracteres, com letras, números e underline! (Não use espaços)\" Senha: \"A senha deve conter pelo menos 6 caracteres, uma letra maiúscula, uma letra minúscula, um número e um caractere especial!\"'),
                                                                        actions: [
                                                                          TextButton(
                                                                            onPressed: () =>
                                                                                Navigator.pop(alertDialogContext),
