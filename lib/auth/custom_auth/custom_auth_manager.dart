...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    logyxappAuthUserSubject.add(
      LogyxappAuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<LogyxappAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  LogyxappAuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = LogyxappAuthUser(
      loggedIn: true,
      uid: authUid,
      userData: userData,
    );
    logyxappAuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
